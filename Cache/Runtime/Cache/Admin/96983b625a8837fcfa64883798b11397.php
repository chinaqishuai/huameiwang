...
<head>
    ...
    <base href="/huameiwang/admin.php/Admin" />
    <!-- css -->
    <link rel="stylesheet" type="text/css" href="/huameiwang/Public/Min/?f=/huameiwang/Public/stylesheets/admin/base.css|/huameiwang/Public/stylesheets/admin/layout.css|/huameiwang/Public/javascripts/admin/asyncbox/skins/default.css" />
...
<body>
    <div class="wrap">
        ...
        <div id="Top">
    <div class="logo">
        <a href="<?php echo U('Index/index');?>"><img src="/huameiwang/Public/images/admin/logo.png" />
        </a>
    </div>
