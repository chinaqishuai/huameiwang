...
class ModelModel extends CommonModel
{
    ...
    {
        $validate = array_merge($this->validateModelName, $this->validateTblName, $this->validateMenuName, $this->validateIsInner, $this->validateHasPk, $this->validateTblEngine);
    ...
    protected function isNotSysTblName($tblName)
    {
        ...
        if (in_array($tblName, $tblNames) || in_array($tblName, $prefixTblNames)) {
            return false;
        }
