...
class FieldModel extends CommonModel
{
    ...
    {
        return $this->validateConditions($this->validateFieldComment, $field, $id);
    }
    ...
    {
        $validate = array_merge($this->validateFieldName, $this->validateFieldComment, $this->validateField);
